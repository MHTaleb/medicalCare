...
public class InfoPersonnel implements Serializable {
    ...
    public InfoPersonnel(String nom, String prenom, String adresse, String tel, boolean sexe,
    ...
    public String toString() {
        return "InfoPersonnel{" + "nom=" + nom + ", prenom=" + prenom + ", adresse=" + adresse + ", tel=" + tel
